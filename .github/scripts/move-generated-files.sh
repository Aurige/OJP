...
if [[ "${GITHUB_REF_NAME}" == 'changes_for_v1.1' ]]; then
  ...
  mkdir ./docs/generated/"${GITHUB_HEAD_REF}"
  mv ./docs/generated/index.html ./docs/generated/"${GITHUB_HEAD_REF}"/
  mv ./docs/generated/asciidoc.css ./docs/generated/"${GITHUB_HEAD_REF}"/
